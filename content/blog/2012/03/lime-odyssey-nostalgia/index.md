...
{{ dress_image(path="blog/2012/03/lime-odyssey-nostalgia/character-select.png", alt="A screenshot of the character select screen from Lime Odyssey", caption="Character select in Lime Odyssey") }}
...
{{ dress_image(path="blog/2012/03/lime-odyssey-nostalgia/crafting-npcs.png", alt="A screenshot of crafting trainer NPCs from Lime Odyssey", caption="Crafting trainer NPCs") }}
...
{{ dress_image(path="blog/2012/03/lime-odyssey-nostalgia/harvesting.png", alt="A screenshot of harvesting from Lime Odyssey", caption="Harvesting in Lime Odyssey") }}
