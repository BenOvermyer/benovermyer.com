...
Now we get to the meat of it - installing Docker and the other tools
...
This will create a new Laravel project called "docker-app" in a new
...
###  {#onelittlegotchamemcachedsetting}
